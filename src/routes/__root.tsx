...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        {
          title:
            "SP Securities | Professional Security Services in Pune & Mumbai",
        },
        {
          name: "description",
          content:
            "Pune-based security company providing professional guarding, residential, commercial, industrial, bouncer, detective and housekeeping services.",
        },
        { name: "author", content: "SP Securities" },
        { name: "robots", content: "index, follow" },
        { name: "geo.region", content: "IN-MH" },
        { name: "geo.placename", content: "Pune, Maharashtra" },
        { property: "og:site_name", content: "SP Securities" },
