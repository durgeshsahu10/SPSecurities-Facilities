import { C as getModularInstance, E as isCloudWorkstation, I as globalthis_default, M as isSafari, N as pingServer, a as getApp, c as registerVersion, d as Component, g as createMockUserToken, i as _registerComponent, l as LogLevel, m as FirebaseError, n as _getProvider, r as _isFirebaseServerApp, t as SDK_VERSION, u as Logger, v as deepEqual, w as getUA, x as getDefaultEmulatorHostnameAndPort } from "./app+[...].mjs";

import { Buffer } from "node:buffer";
//#region node_modules/@firebase/webchannel-wrapper/dist/bloom-blob/esm/bloom_blob_es2018.js
var commonjsGlobal$1 = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof globalthis_default !== "undefined" ? globalthis_default : typeof self !== "undefined" ? self : {};
...
var commonjsGlobal = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof globalthis_default !== "undefined" ? globalthis_default : typeof self !== "undefined" ? self : {};
...
var MAX_BACKTRACK_VECTOR = 262144;
var BitState = class {
	constructor() {
		this.end = 0;
...
* limitations under the License.
*/
var ve = new Logger("@firebase/firestore");
...
*/ var ResourcePath = class ResourcePath extends BasePath {
	...
	*/ static fromString(...t) {
		const n = [];
		for (const r of t) {
			if (r.indexOf("//") >= 0) throw new e(ta.INVALID_ARGUMENT, `Invalid segment (${r}). Paths must not contain // in them.`);
			n.push(...r.split("/").filter(((e) => e.length > 0)));
		}
...
var Fe = /^[_a-zA-Z][_a-zA-Z0-9]*$/;
/**
* A dot-separated path for navigating sub-objects within a document.
* @internal
*/ var Oe = class FieldPath extends BasePath {
	construct(e, t, n) {
	...
	*/ static fromServerFormat(t) {
		...
		const __PRIVATE_addCurrentSegment = () => {
			if (0 === r.length) throw new e(ta.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
			n.push(r), r = "";
		};
		let s = false;
		for (; i < t.length;) {
			const n = t[i];
			if ("\\" === n) {
				if (i + 1 === t.length) throw new e(ta.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
				const n = t[i + 1];
				if ("\\" !== n && "." !== n && "`" !== n) throw new e(ta.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
				r += n, i += 2;
			} else "`" === n ? (s = !s, i++) : "." !== n || s ? (r += n, i++) : (__PRIVATE_addCurrentSegment(), i++);
		}
		if (__PRIVATE_addCurrentSegment(), s) throw new e(ta.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
...
/** Returns a string describing the type / value of the provided input. */ function __PRIVATE_valueDescription(e) {
	...
	return "function" == typeof e ? "a function" : l(12329, { type: typeof e });
}
function ra(t, n) {
	if ("_delegate" in t && (t = t._delegate), !(t instanceof n)) {
		if (n.name === t.constructor.name) throw new e(ta.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
		{
			const r = __PRIVATE_valueDescription(t);
			throw new e(ta.INVALID_ARGUMENT, `Expected type '${n.name}', but it was: ${r}`);
		}
	}
	return t;
}
...
*/ function __PRIVATE_validateJSON(t, n) {
	...
	if (r) throw new e(ta.INVALID_ARGUMENT, r);
	return true;
}
/**
* @license
...
var Timestamp = class Timestamp {
	...
	*/ static fromMillis(e) {
		const t = Math.floor(e / 1e3), n = Math.floor((e - 1e3 * t) * Ne);
	...
	*/ static fromInstant(t) {
		if (!t || "bigint" != typeof t.t) throw new e(ta.INVALID_ARGUMENT, "Invalid Temporal.Instant object provided.");
		return Timestamp._fromEpochNanoseconds(t.t);
	}
	static _fromEpochNanoseconds(e) {
		let t, n;
		if (e >= 0n) t = Number(e / 1000000000n), n = Number(e % 1000000000n);
		else {
			const r = e % 1000000000n;
			0n === r ? (t = Number(e / 1000000000n), n = 0) : (t = Number(e / 1000000000n - 1n), n = Number(r + 1000000000n));
		}
		return new Timestamp(t, n);
	}
	/**
	...
	*     this `Timestamp`.
	*/ toInstant() {
		if ("undefined" == typeof Temporal || !Temporal.Instant) throw new e(ta.FAILED_PRECONDITION, "The Temporal object is not available in the current environment.");
		const t = 1000000000n * BigInt(this.seconds) + BigInt(this.nanoseconds);
		return Temporal.Instant.__PRIVATE_fromEpochNanoseconds(t);
	}
	_compareTo(e) {
...
var Le = /* @__PURE__ */ new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
/**
...
*   localWriteTime.
*/ var Be$1 = "server_timestamp";
var Ue = "__type__";
var ke = "__previous_value__";
var qe = "__local_write_time__";
...
/** The default database name for a project. */ var $e = "(default)";
/**
...
function __PRIVATE_databaseIdFromApp(t, n) {
...
* limitations under the License.
*/
/** Sentinel value that sorts before any Mutation Batch ID. */ var Ke = -1;
/**
...
*/ var Qe = "__type__";
var We = "__max__";
var Ge = { mapValue: { fields: { __type__: { stringValue: We } } } };
var ze = "__vector__";
var je = "value";
var He = { nullValue: "NULL_VALUE" };
var Je = { booleanValue: true };
var Ye = { booleanValue: false };
...
function __PRIVATE_arrayValueContains(e, t) {
	return void 0 !== (e.values || []).find(((e) => __PRIVATE_valueEquals$1(e, t)));
}
	...
	switch (n) {
		...
		case 11: return function __PRIVATE_compareMaps(e, t) {
			...
			for (let e = 0; e < r.length && e < s.length; ++e) {
				...
				if (0 !== t) return t;
				const _ = __PRIVATE_valueCompare(n[r[e]], i[s[e]]);
				if (0 !== _) return _;
			}
...
*/ function __PRIVATE_computeTransformOperationBaseValue(e, t) {
	return e instanceof __PRIVATE_NumericIncrementTransformOperation ? R(t) ? t : { integerValue: 0 } : null;
}
...
function __PRIVATE_applyArrayUnionTransformOperation(e, t) {
	...
	for (const t of e.elements) n.some(((e) => __PRIVATE_valueEquals$1(e, t))) || n.push(t);
...
function __PRIVATE_applyArrayRemoveTransformOperation(e, t) {
	...
	for (const t of e.elements) n = n.filter(((e) => !__PRIVATE_valueEquals$1(e, t)));
	return { arrayValue: { values: n } };
}
/**
...
function __PRIVATE_boundCompareToDocument(e, t, n) {
	...
	for (let i = 0; i < e.position.length; i++) {
		...
		else r = __PRIVATE_valueCompare(_, n.data.field(s.field));
...
*/ function __PRIVATE_boundEquals(e, t) {
	...
	for (let n = 0; n < e.position.length; n++) if (!__PRIVATE_valueEquals$1(e.position[n], t.position[n])) return false;
	return true;
}
/**
* @license
...
function __PRIVATE_filterEquals(e, t) {
	return e instanceof FieldFilter ? function __PRIVATE_fieldFilterEquals(e, t) {
		return t instanceof FieldFilter && e.op === t.op && e.field.isEqual(t.field) && __PRIVATE_valueEquals$1(e.value, t.value);
	}(e, t) : e instanceof CompositeFilter ? function __PRIVATE_compositeFilterEquals(e, t) {
		if (t instanceof CompositeFilter && e.op === t.op && e.filters.length === t.filters.length) return e.filters.reduce(((e, n, r) => e && __PRIVATE_filterEquals(n, t.filters[r])), true);
		return false;
	}(e, t) : void l(19439);
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function __PRIVATE_queryMatches(e, t) {
	return t.isFoundDocument() && function __PRIVATE_queryMatchesPathAndCollectionGroup(e, t) {
		...
		for (const n of __PRIVATE_queryNormalizedOrderBy(e)) if (!n.field.isKeyField() && null === t.data.field(n.field)) return false;
		return true;
...
function __PRIVATE_compareDocs(e, t, n) {
	const r = e.field.isKeyField() ? DocumentKey.comparator(t.key, n.key) : function __PRIVATE_compareDocumentsByField(e, t, n) {
		...
		return null !== r && null !== i ? __PRIVATE_valueCompare(r, i) : l(42886);
	}(e.field, t, n);
	switch (e.dir) {
		case "asc": return r;
...
function __PRIVATE_isPermanentError(e) {
	switch (e) {
		case ta.OK: return l(64938);
		case ta.CANCELLED:
		case ta.UNKNOWN:
		case ta.DEADLINE_EXCEEDED:
		case ta.RESOURCE_EXHAUSTED:
		case ta.INTERNAL:
		case ta.UNAVAILABLE:
		case ta.UNAUTHENTICATED: return false;
		case ta.INVALID_ARGUMENT:
		case ta.NOT_FOUND:
		case ta.ALREADY_EXISTS:
		case ta.PERMISSION_DENIED:
		case ta.FAILED_PRECONDITION:
		case ta.ABORTED:
		case ta.OUT_OF_RANGE:
		case ta.UNIMPLEMENTED:
		case ta.DATA_LOSS: return true;
		default: return l(15467, { code: e });
	}
}
/**
* Determines whether an error code represents a permanent error when received
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var nt = new SortedMap(DocumentKey.comparator);
...
var st = new SortedSet(DocumentKey.comparator);
function __PRIVATE_documentKeySet(...e) {
	let t = st;
	for (const n of e) t = t.add(n);
	return t;
}
var _t = new SortedSet(__PRIVATE_primitiveComparator);
...
* limitations under the License.
*/
var at = new Integer([4294967295, 4294967295], 0);
...
function toMutation(e, t) {
	...
	if (t instanceof __PRIVATE_SetMutation) n = { update: __PRIVATE_toMutationDocument(e, t.key, t.value) };
		...
		if (!(t instanceof __PRIVATE_VerifyMutation)) return l(16599, { be: t.type });
	...
	return t.fieldTransforms.length > 0 && (n.updateTransforms = t.fieldTransforms.map(((e) => function __PRIVATE_toFieldTransform(e, t) {
		...
		throw l(20930, { transform: t.transform });
	}(0, e)))), t.precondition.isNone || (n.currentDocument = function __PRIVATE_toPrecondition(e, t) {
		return void 0 !== t.updateTime ? { updateTime: __PRIVATE_toVersion(e, t.updateTime) } : void 0 !== t.exists ? { exists: t.exists } : l(27497);
	}(e, t.precondition)), n;
}
...
function __PRIVATE_convertQueryTargetToQuery(e) {
	...
	let _ = [];
	n.orderBy && (_ = function __PRIVATE_fromOrder(e) {
	...
	let o = null;
	n.limit && (o = function __PRIVATE_fromInt32Proto(e) {
		let t;
...
*/ var GeoPoint = class GeoPoint {
	...
	*/
	constructor(t, n) {
		if (!isFinite(t) || t < -90 || t > 90) throw new e(ta.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
		if (!isFinite(n) || n < -180 || n > 180) throw new e(ta.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + n);
...
var __PRIVATE_WebChannelConnection = class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
	...
	*/ static gt() {
		if (!__PRIVATE_WebChannelConnection.yt) __PRIVATE_unguardedEventListen(getStatEventTarget(), Event.STAT_EVENT, ((e) => {
	...
	st(t, n, r, i, s) {
		...
		return new Promise(((s, o) => {
			const a = new XhrIo();
			a.setWithCredentials(true), a.listenOnce(EventType.COMPLETE, (() => {
				try {
					switch (a.getLastErrorCode()) {
						...
						case ErrorCode.HTTP_ERROR:
							...
							if (__PRIVATE_logDebug(Rt, `RPC '${t}' ${_} failed with status:`, r, "response text:", a.getResponseText()), r > 0) {
								...
								const n = t?.error;
								if (n && n.status && n.message) o(new e(function __PRIVATE_mapCodeFromHttpResponseErrorStatus(e) {
									const t = e.toLowerCase().replace(/_/g, "-");
									return Object.values(ta).indexOf(t) >= 0 ? t : ta.UNKNOWN;
								}(n.status), n.message));
								else o(new e(ta.UNKNOWN, "Server responded with status " + a.getStatus()));
	...
	vt(t, n, r) {
		const i = __PRIVATE_generateUniqueDebugId(), s = [
			...
			t,
			"/channel"
		], _ = this.createWebChannelTransport(), o = {
...
*/ var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
	...
	*/ get Rn() {
	...
	hn(e) {
		return __PRIVATE_hardAssert(!!e.streamToken, 31322), this.lastStreamToken = e.streamToken, __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length, 55816), this.listener.Vn();
	}
	onNext(e) {
		__PRIVATE_hardAssert(!!e.streamToken, 12678), this.lastStreamToken = e.streamToken, this.Ht.reset();
	...
	*/ fn() {
		const e = {};
		e.database = __PRIVATE_getEncodedDatabaseId(this.serializer), this.nn(e);
	}
	/** Sends a group of mutations to the Firestore backend to apply. */ An(e) {
		const t = {
...
*/ var PersistencePromise = class PersistencePromise {
	constructor(e) {
		this.nextCallback = null, this.catchCallback = null, this.result = void 0, this.error = void 0, this.isDone = false, this.callbackAttached = false, e(((e) => {
			this.isDone = true, this.result = e, this.nextCallback && this.nextCallback(e);
		}), ((e) => {
	...
	next(e, t) {
		return this.callbackAttached && l(59440), this.callbackAttached = true, this.isDone ? this.error ? this.wrapFailure(t, this.error) : this.wrapSuccess(e, this.result) : new PersistencePromise(((n, r) => {
			this.nextCallback = (t) => {
...
* limitations under the License.
*/
var St = "firestore.googleapis.com";
var vt = true;
/**
	...
	constructor(t) {
		...
		if (__PRIVATE_validateIsNotUsedTogether("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = false : void 0 === t.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = true : this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, this.experimentalLongPollingOptions = __PRIVATE_cloneLongPollingOptions(t.experimentalLongPollingOptions ?? {}), function __PRIVATE_validateLongPollingOptions(t) {
			if (void 0 !== t.timeoutSeconds) {
				if (isNaN(t.timeoutSeconds)) throw new e(ta.INVALID_ARGUMENT, `invalid long polling timeout: ${t.timeoutSeconds} (must not be NaN)`);
				if (t.timeoutSeconds < 5) throw new e(ta.INVALID_ARGUMENT, `invalid long polling timeout: ${t.timeoutSeconds} (minimum allowed value is 5)`);
...
var Dt = class Firestore {
	...
	* instance.
	*/ get app() {
		if (!this._app) throw new e(ta.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
		return this._app;
	}
	get _initialized() {
	...
	_setSettings(t) {
		if (this._settingsFrozen) throw new e(ta.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
		this._settings = new FirestoreSettingsImpl(t), this._emulatorOptions = t.emulatorOptions || {}, void 0 !== t.credentials && (this._authCredentials = function __PRIVATE_makeAuthCredentialsProvider(t) {
			if (!t) return new __PRIVATE_EmptyAuthCredentialsProvider();
			switch (t.type) {
				case "firstParty": return new __PRIVATE_FirstPartyAuthCredentialsProvider(t.sessionIndex || "0", t.iamToken || null, t.authTokenFactory || null);
				case "provider": return t.client;
				default: throw new e(ta.INVALID_ARGUMENT, "makeAuthCredentialsProvider failed due to invalid credential type");
			}
		}(t.credentials));
	}
	_getSettings() {
...
*/ function connectFirestoreEmulator(t, n, r, i = {}) {
	...
	if (!deepEqual(u, o) && (t._setSettings(u), i.mockUserToken)) {
		let n, r;
		if ("string" == typeof i.mockUserToken) n = i.mockUserToken, r = User.MOCK_USER;
		else {
			n = createMockUserToken(i.mockUserToken, t._app?.options.projectId);
			const s = i.mockUserToken.sub || i.mockUserToken.user_id;
			if (!s) throw new e(ta.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
			r = new User(s);
		}
		t._authCredentials = new __PRIVATE_EmulatorAuthCredentialsProvider(new __PRIVATE_OAuthToken(n, r));
	}
}
/**
* @license
...
*/ var aa = class aa {
	...
	*/ get parent() {
		return new na(this.firestore, this.converter, this._key.path.popLast());
	}
	withConverter(e) {
		return new aa(this.firestore, e, this._key);
	}
	/**
	...
	*/ toJSON() {
		return {
			type: aa._jsonSchemaVersion,
			referencePath: this._key.toString()
		};
	}
	static fromJSON(e, t, n) {
		if (__PRIVATE_validateJSON(t, aa._jsonSchema)) return new aa(e, n || null, new DocumentKey(ResourcePath.fromString(t.referencePath)));
	}
};
aa._jsonSchemaVersion = "firestore/documentReference/1.0", aa._jsonSchema = {
	type: property("string", aa._jsonSchemaVersion),
...
var na = class na extends Query {
	...
	*/ get parent() {
		...
		return e.isEmpty() ? null : new aa(this.firestore, null, new DocumentKey(e));
	}
	withConverter(e) {
...
var n = class n {
	...
	* {@link FirestoreError} if an error occurs.
	*/ static fromJSON(t) {
		if (__PRIVATE_validateJSON(t, n._jsonSchema)) {
			if (Array.isArray(t.vectorValues) && t.vectorValues.every(((e) => "number" == typeof e))) return new n(t.vectorValues);
			throw new e(ta.INVALID_ARGUMENT, "Expected 'vectorValues' field to be a number array");
		}
	}
};
n._jsonSchemaVersion = "firestore/vectorValue/1.0", n._jsonSchema = {
...
/** Parse document data from a set() call. */ function __PRIVATE_parseSetData(t, n, r, i, s, _ = {}) {
	const o = t.createContext(_.merge || _.mergeFields ? 2 : 0, n, r, s);
	__PRIVATE_validatePlainObject("Data must be an object, but it was:", o, i);
	const a = __PRIVATE_parseObject(i, o);
	let u, c;
	if (_.merge) u = new FieldMask(o.fieldMask), c = o.fieldTransforms;
	else if (_.mergeFields) {
		const t = [];
		for (const i of _.mergeFields) {
			const s = K(n, i, r);
			if (!o.contains(s)) throw new e(ta.INVALID_ARGUMENT, `Field '${s}' is specified in your field mask but missing from your input data.`);
			__PRIVATE_fieldMaskContains(t, s) || t.push(s);
		}
		u = new FieldMask(t), c = o.fieldTransforms.filter(((e) => u.covers(e.field)));
	} else u = null, c = o.fieldTransforms;
	return new ParsedSetData(new ObjectValue(a), u, c);
}
...
*/ function __PRIVATE_parseData(e, t, r) {
 ...
 /**
	...
	*/
	...
	return function __PRIVATE_parseScalarValue(e, t, r) {
		...
		if (__PRIVATE_isTemporalInstant(e)) {
			const n = Timestamp.fromInstant(e), r = new Timestamp(n.seconds, 1e3 * Math.floor(n.nanoseconds / 1e3));
			return { timestampValue: toTimestamp(t.serializer, r) };
		}
...
function __PRIVATE_isTemporalInstant(e) {
	if ("object" != typeof e || null === e) return false;
	if ("undefined" != typeof Temporal && "function" == typeof Temporal.Instant) {
		if (e instanceof Temporal.Instant) return true;
	}
	const t = e;
...
*/ function K(e, t, n) {
	...
	throw createError("Field path arguments must be of type string or ", e, false, void 0, n);
}
/**
* Matches any characters in a field path string that are reserved.
*/ var Ct = /* @__PURE__ */ new RegExp("[~\\*/\\[\\]]");
/**
...
*/ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
	...
	try {
		...
		throw createError(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, e, false, void 0, n);
	}
}
function createError(t, n, r, i, s) {
	const _ = i && !i.isEmpty(), o = void 0 !== s;
	let a = `Function ${n}() called with invalid data`;
	r && (a += " (via `toFirestore()`)"), a += ". ";
	let u = "";
	return (_ || o) && (u += " (found", _ && (u += ` in field ${i}`), o && (u += ` in document ${s}`), u += ")"), new e(ta.INVALID_ARGUMENT, a + t + u);
}
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var OptionsUtil = class OptionsUtil {
	constructor(e) {
...
function u(e) {
	return "object" == typeof e && null !== e && !!("nullValue" in e && (null === e.nullValue || "NULL_VALUE" === e.nullValue) || "booleanValue" in e && (null === e.booleanValue || "boolean" == typeof e.booleanValue) || "integerValue" in e && (null === e.integerValue || "number" == typeof e.integerValue || "string" == typeof e.integerValue) || "doubleValue" in e && (null === e.doubleValue || "number" == typeof e.doubleValue) || "timestampValue" in e && (null === e.timestampValue || function __PRIVATE_isITimestamp(e) {
		...
		return "object" == typeof e && null !== e && !(!("fields" in e) || null !== e.fields && !p(e.fields));
...
*/ function __PRIVATE_valueToDefaultExpr(e) {
	let n;
	return e instanceof t ? e : (n = p(e) ? __PRIVATE__map(e) : e instanceof Array ? b(e) : m(e, void 0), n);
}
/**
* Converts a value to an Expression, Returning either a Constant, MapFunction,
* ArrayFunction, or the input itself (if it's already an expression).
...
*/ function __PRIVATE_fieldOrExpression(e) {
	if (__PRIVATE_isString$1(e)) return s(e);
...
*/ var t = class {
	...
	*/ add(e) {
		return new y("add", [this, __PRIVATE_valueToDefaultExpr(e)], "add");
	}
	/**
	...
	*/ asBoolean() {
		...
		if (this instanceof o) return new __PRIVATE_BooleanField(this);
		if (this instanceof y) return new __PRIVATE_BooleanFunctionExpression(this);
		throw new e("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
	}
	subtract(e) {
		return new y("subtract", [this, __PRIVATE_valueToDefaultExpr(e)], "subtract");
	}
	/**
	...
	*/ multiply(e) {
		return new y("multiply", [this, __PRIVATE_valueToDefaultExpr(e)], "multiply");
	}
	divide(e) {
		return new y("divide", [this, __PRIVATE_valueToDefaultExpr(e)], "divide");
	}
	mod(e) {
		return new y("mod", [this, __PRIVATE_valueToDefaultExpr(e)], "mod");
	}
	equal(e) {
		return new y("equal", [this, __PRIVATE_valueToDefaultExpr(e)], "equal").asBoolean();
	}
	notEqual(e) {
		return new y("not_equal", [this, __PRIVATE_valueToDefaultExpr(e)], "notEqual").asBoolean();
	}
	lessThan(e) {
		return new y("less_than", [this, __PRIVATE_valueToDefaultExpr(e)], "lessThan").asBoolean();
	}
	lessThanOrEqual(e) {
		return new y("less_than_or_equal", [this, __PRIVATE_valueToDefaultExpr(e)], "lessThanOrEqual").asBoolean();
	}
	greaterThan(e) {
		return new y("greater_than", [this, __PRIVATE_valueToDefaultExpr(e)], "greaterThan").asBoolean();
	}
	greaterThanOrEqual(e) {
		return new y("greater_than_or_equal", [this, __PRIVATE_valueToDefaultExpr(e)], "greaterThanOrEqual").asBoolean();
	}
	/**
	...
	*/ arrayConcat(e, ...t) {
		const n = [e, ...t].map(((e) => __PRIVATE_valueToDefaultExpr(e)));
		return new y("array_concat", [this, ...n], "arrayConcat");
	}
	arrayContains(e) {
		return new y("array_contains", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayContains").asBoolean();
	}
	arrayContainsAll(e) {
		const t = Array.isArray(e) ? new __PRIVATE_ListOfExprs(e.map(__PRIVATE_valueToDefaultExpr), "arrayContainsAll") : e;
		return new y("array_contains_all", [this, t], "arrayContainsAll").asBoolean();
	}
	arrayContainsAny(e) {
		const t = Array.isArray(e) ? new __PRIVATE_ListOfExprs(e.map(__PRIVATE_valueToDefaultExpr), "arrayContainsAny") : e;
		return new y("array_contains_any", [this, t], "arrayContainsAny").asBoolean();
	}
	/**
	...
	*/ arrayReverse() {
		return new y("array_reverse", [this]);
	}
	/**
	...
	*/ exists() {
		return new y("exists", [this], "exists").asBoolean();
	}
	/**
	...
	*/ charLength() {
		return new y("char_length", [this], "charLength");
	}
	like(e) {
		return new y("like", [this, __PRIVATE_valueToDefaultExpr(e)], "like").asBoolean();
	}
	regexContains(e) {
		return new y("regex_contains", [this, __PRIVATE_valueToDefaultExpr(e)], "regexContains").asBoolean();
	}
	regexFind(e) {
		return new y("regex_find", [this, __PRIVATE_valueToDefaultExpr(e)], "regexFind");
	}
	regexFindAll(e) {
		return new y("regex_find_all", [this, __PRIVATE_valueToDefaultExpr(e)], "regexFindAll");
	}
	regexMatch(e) {
		return new y("regex_match", [this, __PRIVATE_valueToDefaultExpr(e)], "regexMatch").asBoolean();
	}
	stringContains(e) {
		return new y("string_contains", [this, __PRIVATE_valueToDefaultExpr(e)], "stringContains").asBoolean();
	}
	startsWith(e) {
		return new y("starts_with", [this, __PRIVATE_valueToDefaultExpr(e)], "startsWith").asBoolean();
	}
	endsWith(e) {
		return new y("ends_with", [this, __PRIVATE_valueToDefaultExpr(e)], "endsWith").asBoolean();
	}
	/**
	...
	*/ toLower() {
		return new y("to_lower", [this], "toLower");
	}
	/**
	...
	*/ toUpper() {
		return new y("to_upper", [this], "toUpper");
	}
	/**
	...
	*/ trim(e) {
		const t = [this];
		return e && t.push(__PRIVATE_valueToDefaultExpr(e)), new y("trim", t, "trim");
	}
	/**
	...
	*/ ltrim(e) {
		const t = [this];
		return e && t.push(__PRIVATE_valueToDefaultExpr(e)), new y("ltrim", t, "ltrim");
	}
	/**
	...
	*/ rtrim(e) {
		const t = [this];
		return e && t.push(__PRIVATE_valueToDefaultExpr(e)), new y("rtrim", t, "rtrim");
	}
	/**
	...
	*/ isType(e) {
		return new y("is_type", [this, i(e)], "isType").asBoolean();
	}
	/**
	...
	*/ stringConcat(e, ...t) {
		...
		return new y("string_concat", [this, ...n], "stringConcat");
	}
	/**
	...
	*/ stringIndexOf(e) {
		return new y("string_index_of", [this, __PRIVATE_valueToDefaultExpr(e)], "stringIndexOf");
	}
	/**
	...
	*/ stringRepeat(e) {
		return new y("string_repeat", [this, __PRIVATE_valueToDefaultExpr(e)], "stringRepeat");
	}
	/**
	...
	*/ stringReplaceAll(e, t) {
		return new y("string_replace_all", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			__PRIVATE_valueToDefaultExpr(t)
		], "stringReplaceAll");
	}
	/**
	...
	*/ stringReplaceOne(e, t) {
		return new y("string_replace_one", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			__PRIVATE_valueToDefaultExpr(t)
		], "stringReplaceOne");
	...
	*/ concat(e, ...t) {
		const n = [e, ...t].map(__PRIVATE_valueToDefaultExpr);
		return new y("concat", [this, ...n], "concat");
	}
	/**
	...
	*/ reverse() {
		return new y("reverse", [this], "reverse");
	}
	/**
	...
	*/ arraySlice(e, t) {
		...
		return void 0 !== t && n.push(__PRIVATE_valueToDefaultExpr(t)), new y("array_slice", n, "arraySlice");
	}
	/**
	...
	*/ arrayFirst() {
		return new y("array_first", [this], "arrayFirst");
	}
	arrayFirstN(e) {
		return new y("array_first_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayFirstN");
	}
	/**
	...
	*/ arrayLast() {
		return new y("array_last", [this], "arrayLast");
	}
	arrayLastN(e) {
		return new y("array_last_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayLastN");
	}
	/**
	...
	*/ arrayMaximum() {
		return new y("maximum", [this], "arrayMaximum");
	}
	arrayMaximumN(e) {
		return new y("maximum_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayMaximumN");
	}
	/**
	...
	*/ arrayMinimum() {
		return new y("minimum", [this], "arrayMinimum");
	}
	arrayMinimumN(e) {
		return new y("minimum_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayMinimumN");
	}
	arrayIndexOf(e) {
		return new y("array_index_of", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			__PRIVATE_valueToDefaultExpr("first")
		], "arrayIndexOf");
	}
	arrayLastIndexOf(e) {
		return new y("array_index_of", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			__PRIVATE_valueToDefaultExpr("last")
		], "arrayLastIndexOf");
	}
	arrayIndexOfAll(e) {
		return new y("array_index_of_all", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayIndexOfAll");
	}
	/**
	...
	*/ byteLength() {
		return new y("byte_length", [this], "byteLength");
	}
	/**
	...
	*/ mapGet(e) {
		return new y("map_get", [this, i(e)], "mapGet");
	}
	/**
	...
	*/ mapSet(e, t, ...n) {
		return new y("map_set", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			__PRIVATE_valueToDefaultExpr(t),
			...n.map(__PRIVATE_valueToDefaultExpr)
		], "mapSet");
	}
	/**
	...
	*/ mapKeys() {
		return new y("map_keys", [this], "mapKeys");
	}
	/**
	...
	*/ mapValues() {
		return new y("map_values", [this], "mapValues");
	}
	/**
	...
	*/ mapEntries() {
		return new y("map_entries", [this], "mapEntries");
	}
	/**
	* @public
	...
	*/ getField(e) {
		return new y("get_field", [this, __PRIVATE_valueToDefaultExpr(e)], "get_field");
	}
	/**
	...
	*/ count() {
		return k._create("count", [this], "count");
	}
	/**
	...
	*/ average() {
		return k._create("average", [this], "average");
	}
	/**
	...
	*/ minimum() {
		return k._create("minimum", [this], "minimum");
	}
	/**
	...
	*/ maximum() {
		return k._create("maximum", [this], "maximum");
	}
	/**
	...
	*/ first() {
		return k._create("first", [this], "first");
	}
	/**
	...
	*/ last() {
		return k._create("last", [this], "last");
	}
	/**
	...
	*/ arrayAgg() {
		return k._create("array_agg", [this], "arrayAgg");
	}
	/**
	...
	*/ arrayAggDistinct() {
		return k._create("array_agg_distinct", [this], "arrayAggDistinct");
	}
	/**
	...
	*/ countDistinct() {
		return k._create("count_distinct", [this], "countDistinct");
	}
	/**
	...
	*/ logicalMaximum(e, ...t) {
		const n = [e, ...t];
		return new y("maximum", [this, ...n.map(__PRIVATE_valueToDefaultExpr)], "logicalMaximum");
	}
	/**
	...
	*/ logicalMinimum(e, ...t) {
		const n = [e, ...t];
		return new y("minimum", [this, ...n.map(__PRIVATE_valueToDefaultExpr)], "minimum");
	}
	/**
	...
	*/ vectorLength() {
		return new y("vector_length", [this], "vectorLength");
	}
	cosineDistance(e) {
		return new y("cosine_distance", [this, __PRIVATE_vectorToExpr(e)], "cosineDistance");
	}
	dotProduct(e) {
		return new y("dot_product", [this, __PRIVATE_vectorToExpr(e)], "dotProduct");
	}
	euclideanDistance(e) {
		return new y("euclidean_distance", [this, __PRIVATE_vectorToExpr(e)], "euclideanDistance");
	}
	/**
	...
	*/ unixMicrosToTimestamp() {
		return new y("unix_micros_to_timestamp", [this], "unixMicrosToTimestamp");
	}
	/**
	...
	*/ timestampToUnixMicros() {
		return new y("timestamp_to_unix_micros", [this], "timestampToUnixMicros");
	}
	/**
	...
	*/ unixMillisToTimestamp() {
		return new y("unix_millis_to_timestamp", [this], "unixMillisToTimestamp");
	}
	/**
	...
	*/ timestampToUnixMillis() {
		return new y("timestamp_to_unix_millis", [this], "timestampToUnixMillis");
	}
	/**
	...
	*/ unixSecondsToTimestamp() {
		return new y("unix_seconds_to_timestamp", [this], "unixSecondsToTimestamp");
	}
	/**
	...
	*/ timestampToUnixSeconds() {
		return new y("timestamp_to_unix_seconds", [this], "timestampToUnixSeconds");
	}
	timestampAdd(e, t) {
		return new y("timestamp_add", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			__PRIVATE_valueToDefaultExpr(t)
		], "timestampAdd");
	...
	timestampSubtract(e, t) {
		return new y("timestamp_subtract", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			__PRIVATE_valueToDefaultExpr(t)
		], "timestampSubtract");
	...
	timestampDiff(e, t) {
		return new y("timestamp_diff", [
			this,
			__PRIVATE_fieldOrExpression(e),
			__PRIVATE_valueToDefaultExpr(t)
		], "timestampDiff");
	}
	timestampExtract(e, t) {
		const n = [this, __PRIVATE_valueToDefaultExpr(e)];
		return t && n.push(__PRIVATE_valueToDefaultExpr(t)), new y("timestamp_extract", n, "timestampExtract");
	}
	/**
	*
	...
	*/ documentId() {
		return new y("document_id", [this], "documentId");
	}
	/**
	*
	...
	*/ parent() {
		return new y("parent", [this], "parent");
	}
	substring(e, t) {
		const n = __PRIVATE_valueToDefaultExpr(e);
		return new y("substring", void 0 === t ? [this, n] : [
			this,
			n,
			__PRIVATE_valueToDefaultExpr(t)
		], "substring");
	...
	arrayGet(e) {
		return new y("array_get", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayGet");
	}
	/**
	*
	...
	*/ isError() {
		return new y("is_error", [this], "isError").asBoolean();
	}
	ifError(e) {
		const t = new y("if_error", [this, __PRIVATE_valueToDefaultExpr(e)], "ifError");
	...
	*/ isAbsent() {
		return new y("is_absent", [this], "isAbsent").asBoolean();
	}
	mapRemove(e) {
		return new y("map_remove", [this, __PRIVATE_valueToDefaultExpr(e)], "mapRemove");
	}
	/**
	*
	...
	*/ mapMerge(e, ...t) {
	...
	pow(e) {
		return new y("pow", [this, __PRIVATE_valueToDefaultExpr(e)]);
	}
	trunc(e) {
		return void 0 === e ? new y("trunc", [this]) : new y("trunc", [this, __PRIVATE_valueToDefaultExpr(e)], "trunc");
	}
	round(e) {
		return void 0 === e ? new y("round", [this]) : new y("round", [this, __PRIVATE_valueToDefaultExpr(e)], "round");
	}
	/**
	...
	*/ collectionId() {
		return new y("collection_id", [this]);
	}
	/**
	...
	* @returns A new {@link @firebase/firestore/pipelines#Expression} representing the reversed string.
	*/ stringReverse() {
		return new y("string_reverse", [this]);
	}
	ifAbsent(e) {
		return new y("if_absent", [this, __PRIVATE_valueToDefaultExpr(e)], "ifAbsent");
	}
	ifNull(e) {
		return new y("if_null", [this, __PRIVATE_valueToDefaultExpr(e)], "ifNull");
	}
	/**
	...
	*/ coalesce(e, ...t) {
		return new y("coalesce", [
			this,
			__PRIVATE_valueToDefaultExpr(e),
			...t.map(__PRIVATE_valueToDefaultExpr)
		], "coalesce");
	}
	join(e) {
		return new y("join", [this, __PRIVATE_valueToDefaultExpr(e)], "join");
	}
	/**
	...
	*/ arraySum() {
		return new y("sum", [this]);
	}
	split(e) {
		return new y("split", [this, __PRIVATE_valueToDefaultExpr(e)]);
	}
	timestampTruncate(e, t) {
		const n = [this, __PRIVATE_valueToDefaultExpr(e)];
		return t && n.push(__PRIVATE_valueToDefaultExpr(t)), new y("timestamp_trunc", n);
	}
	/**
...
*/ var o = class extends t {
	...
	*/
	geoDistance(e) {
		return new y("geo_distance", [this, __PRIVATE_valueToDefaultExpr(e)], "geoDistance");
	}
	/**
	* @private
	* @internal
...
* ```
*/ var Constant = class Constant extends t {
	/**
	* @private
	* @internal
	* @hideconstructor
	...
	* @internal
	*/ _readUserData(e) {
		e = this._methodName ? e.contextWith({ methodName: this._methodName }) : e, u(this._protoValue) || (this._protoValue = __PRIVATE_parseData(this.value, e));
	}
};
function i(e, t) {
	return m(e, "constant");
...
*/ var y = class extends t {
	...
	*/
	constructor(e, t, n, r) {
		super(), this.name = e, this.params = t, this.expressionType = "Function", this._optionsProto = void 0, void 0 !== n && (this._methodName = n), void 0 !== r && (this._options = r);
	}
	/**
	* @private
	* @internal
...
*/ var BooleanExpression = class BooleanExpression extends t {
	get _methodName() {
	...
	*/ countIf() {
		return k._create("count_if", [this], "countIf");
	}
	/**
	...
	*/ not() {
		return new y("not", [this], "not").asBoolean();
	}
	/**
	...
	*/ conditional(e, t) {
	...
	ifError(e) {
		const t = __PRIVATE_valueToDefaultExpr(e), n = new y("if_error", [this, t], "ifError");
...
function __PRIVATE__map(e, t) {
	...
	for (const t in e) if (Object.prototype.hasOwnProperty.call(e, t)) {
		const r = e[t];
		n.push(i(t)), n.push(__PRIVATE_valueToDefaultExpr(r));
	}
	return new y("map", n, "map");
}
/**
*
...
*/ function b(e) {
	return function __PRIVATE__array(e, t) {
		return new y("array", e.map(((e) => __PRIVATE_valueToDefaultExpr(e))), t);
	}(e, "array");
}
...
function getPipelineCollectionId(e) {
	switch (getPipelineSourceType(e)) {
		case "collection": return ResourcePath.fromString(getPipelineCollection(e)).lastSegment();
		case "collection_group": return getPipelineCollectionGroup(e);
		default: return;
	}
}
...
var __PRIVATE_EvaluateResult = class __PRIVATE_EvaluateResult {
	...
	static newValue(e) {
		...
		}(e) ? new __PRIVATE_EvaluateResult("STRING", e) : function __PRIVATE_isBytes(e) {
...
function __PRIVATE_toEvaluable(e) {
	if ((e = __PRIVATE_unwrapExpression(e)) instanceof o) return new __PRIVATE_CoreField(e);
...
var __PRIVATE_CoreField = class {
	...
	evaluate(e, t) {
		...
		return n ? __PRIVATE_isServerTimestamp(n) ? __PRIVATE_EvaluateResult.newValue(function __PRIVATE_getServerTimestampValue(e, t) {
			if ("estimate" === e.serverTimestampBehavior) return { timestampValue: __PRIVATE_toVersion(e.serializer, SnapshotVersion.fromTimestamp(__PRIVATE_getLocalWriteTime(t))) };
			if ("previous" === e.serverTimestampBehavior) {
				const e = __PRIVATE_getPreviousValue(t);
				if (e) return e;
			}
...
var __PRIVATE_CoreListOfExprs = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var Ft = BigInt("0x7fffffffffffffff");
var Ot = -BigInt("0x8000000000000000");
...
function __PRIVATE_strictValueEquals(e, t) {
	return __PRIVATE_typeOrder(e) !== __PRIVATE_typeOrder(t) ? "TYPE_MISMATCH" : __PRIVATE_isNanValue(e) || __PRIVATE_isNanValue(t) ? "NOT_EQ" : __PRIVATE_isNullValue(e) && __PRIVATE_isNullValue(t) ? "EQ" : __PRIVATE_isNullValue(e) || __PRIVATE_isNullValue(t) ? "NULL" : isArray(e) && isArray(t) ? function __PRIVATE_strictArrayValueEquals(e, t) {
		if (e.values?.length !== t.values?.length) return "NOT_EQ";
		let n = false;
		for (let r = 0; r < (e.values?.length ?? 0); r++) {
			const i = e.values[r], s = t.values[r];
		...
		if (n) return "NULL";
		return "EQ";
	}(e.arrayValue, t.arrayValue) : __PRIVATE_isVectorValue(e) && __PRIVATE_isVectorValue(t) || __PRIVATE_isMapValue(e) && __PRIVATE_isMapValue(t) ? function __PRIVATE_strictObjectValueEquals(e, t) {
		const n = e.fields || {}, r = t.fields || {};
		if (__PRIVATE_objectSize(n) !== __PRIVATE_objectSize(r)) return "NOT_EQ";
		let i = false;
		for (const e in n) if (n.hasOwnProperty(e)) {
			if (void 0 === r[e]) return "NOT_EQ";
			switch (__PRIVATE_strictValueEquals(n[e], r[e])) {
				case "NOT_EQ":
				case "TYPE_MISMATCH": return "NOT_EQ";
				case "NULL": i = true;
			}
...
var __PRIVATE_CoreSubtract = class extends __PRIVATE_BigIntOrDoubleArithmetics {
	constructor(e) {
		super(e), this.expr = e;
	}
	vr(e, t) {
...
var __PRIVATE_CoreMultiply = class extends __PRIVATE_BigIntOrDoubleArithmetics {
	constructor(e) {
		super(e), this.expr = e;
	}
	vr(e, t) {
...
var __PRIVATE_CoreDivide = class extends __PRIVATE_BigIntOrDoubleArithmetics {
	constructor(e) {
		super(e), this.expr = e;
	}
	vr(e, t) {
...
var __PRIVATE_CoreMod = class extends __PRIVATE_BigIntOrDoubleArithmetics {
	constructor(e) {
		super(e), this.expr = e;
	}
	vr(e, t) {
...
var __PRIVATE_CoreNotEqAny = class {
	...
	evaluate(e, t) {
		return new __PRIVATE_CoreNot(new y("not", [new y("equal_any", this.expr.params)])).evaluate(e, t);
	}
};
var __PRIVATE_CoreIsNan = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreIsNotNan = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
		__PRIVATE_hardAssert(1 === this.expr.params.length, 50406);
		return new __PRIVATE_CoreNot(new y("not", [new y("is_nan", this.expr.params)])).evaluate(e, t);
	}
};
var __PRIVATE_CoreIsNull = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreIsNotNull = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
		__PRIVATE_hardAssert(1 === this.expr.params.length, 23167);
		return new __PRIVATE_CoreNot(new y("not", [new y("is_null", this.expr.params)])).evaluate(e, t);
	}
};
var __PRIVATE_CoreIsError = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreLogicalMaximum = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
		const n = this.expr.params.map(((n) => __PRIVATE_toEvaluable(n).evaluate(e, t)));
		let r;
		for (const e of n) switch (e.type) {
			case "ERROR":
			case "UNSET":
			case "NULL": continue;
...
var __PRIVATE_CoreNeq = class extends __PRIVATE_ComparisonBase {
	constructor(e) {
		super(e), this.expr = e;
	}
	Fr(e, t) {
...
var __PRIVATE_CoreLt = class extends __PRIVATE_ComparisonBase {
	constructor(e) {
		super(e), this.expr = e;
	}
	Fr(e, t) {
...
var __PRIVATE_CoreArrayReverse = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreArrayContains = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
		return __PRIVATE_hardAssert(2 === this.expr.params.length, 52884), new __PRIVATE_CoreEqAny(new y("eq_any", [this.expr.params[1], this.expr.params[0]])).evaluate(e, t);
	}
};
var __PRIVATE_CoreArrayContainsAll = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
		...
		for (const e of s) {
			...
			n = false;
			for (const r of _) {
				switch (__PRIVATE_isNullValue(e) && __PRIVATE_isNullValue(r) ? "EQ" : __PRIVATE_strictValueEquals(e, r)) {
					case "EQ":
						t = true;
						break;
					case "NOT_EQ":
...
var __PRIVATE_CoreArrayElement = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreReverse = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
		...
		switch (n.type) {
			...
			case "BYTES": {
				...
				if ("string" == typeof e) {
					const t = ByteString.fromBase64String(e).toUint8Array();
					return t.reverse(), __PRIVATE_EvaluateResult.newValue({ bytesValue: ByteString.fromUint8Array(t).toBase64() });
				}
				return __PRIVATE_EvaluateResult.newValue({ bytesValue: new Uint8Array(e).reverse() });
			}
			case "STRING": {
...
var __PRIVATE_CoreReplaceFirst = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreReplaceAll = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreCharLength = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
			...
			case "STRING": {
				const e = function __PRIVATE_getUnicodePointCount(e) {
					...
					for (let n = 0; n < e.length; n++) {
						...
						if (void 0 === r) return;
						if (r <= 65535) if (r >= 55296 && r <= 57343) if (r <= 56319) {
							const r = e.codePointAt(n + 1);
							void 0 !== r && r >= 56320 && r <= 57343 ? (t += 1, n++) : t += 1;
						} else t += 1;
						else t += 1;
						else {
							if (!(r <= 1114111)) return;
...
var __PRIVATE_CoreByteLength = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
		...
		switch (n.type) {
			case "BYTES": {
				const e = n.value?.bytesValue;
				return "string" == typeof e ? __PRIVATE_EvaluateResult.newValue({ integerValue: ByteString.fromBase64String(e).toUint8Array().length }) : __PRIVATE_EvaluateResult.newValue({ integerValue: new Uint8Array(e).length });
			}
			case "STRING": {
				const e = function __PRIVATE_getUtf8ByteLength(e) {
					let t = 0;
					for (let n = 0; n < e.length; n++) {
						const r = e.codePointAt(n);
						if (void 0 === r) return;
						if (r >= 55296 && r <= 57343) {
							...
							{
								const r = e.codePointAt(n + 1);
								if (void 0 === r || !(r >= 56320 && r <= 57343)) return;
								t += 4, n++;
							}
						} else if (r <= 127) t += 1;
						else if (r <= 2047) t += 2;
...
var __PRIVATE_StringSearchFunctionBase = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreToLower = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreToUpper = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreStrConcat = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_CoreCosineDistance = class extends __PRIVATE_DistanceBase {
	Mr(e, t) {
		...
		for (let e = 0; e < n.length; e++) {
			if (!R(n[e]) || !R(r[e])) return;
			const t = __PRIVATE_asDouble(n[e]), o = __PRIVATE_asDouble(r[e]);
			i += t * o, s += t * t, _ += o * o;
		}
...
var __PRIVATE_CoreDotProduct = class extends __PRIVATE_DistanceBase {
	Mr(e, t) {
		...
		for (let e = 0; e < n.length; e++) {
			if (!R(n[e]) || !R(r[e])) return;
			i += __PRIVATE_asDouble(n[e]) * __PRIVATE_asDouble(r[e]);
		}
		return i;
	}
};
var __PRIVATE_CoreEuclideanDistance = class extends __PRIVATE_DistanceBase {
	Mr(e, t) {
		...
		for (let e = 0; e < n.length; e++) {
			if (!R(n[e]) || !R(r[e])) return;
			const t = __PRIVATE_asDouble(n[e]), s = __PRIVATE_asDouble(r[e]);
			i += Math.pow(t - s, 2);
		}
		return Math.sqrt(i);
	}
};
var __PRIVATE_CoreVectorLength = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var Mt = BigInt(-62135596800);
var Nt = BigInt(253402300799);
var Lt = BigInt(1e3);
var Bt = BigInt(1e6);
var Ut = Mt * Lt;
var kt = Nt * Lt + BigInt(999);
var qt = Mt * Bt;
var $t = Nt * Bt + BigInt(999999);
...
var __PRIVATE_TimestampToUnix = class {
	constructor(e) {
		this.expr = e;
	}
	evaluate(e, t) {
...
var __PRIVATE_TimestampArithmetic = class {
	...
	evaluate(e, t) {
		...
		switch (i.type) {
			case "STRING":
				if (s = function __PRIVATE_asTimeUnit(e) {
					switch (e) {
...
function __PRIVATE_canonifyStage(e) {
	if (e instanceof w) return `${e._name}(${__PRIVATE_canonifyExprMap(e.fields)})`;
	if (e instanceof O) {
	...
	if (e instanceof L) return `${e._name}(${function __PRIVATE_canonifySortOrderings(e) {
		return e.map(((e) => `${__PRIVATE_canonifyExpr(e.expr)}${e.direction}`)).join(",");
	}(e.orderings)})`;
	throw new Error(`Unrecognized stage ${e._name}`);
}
function __PRIVATE_canonifyExprMap(e) {
	return `${Array.from(e.entries()).sort().map((([e, t]) => `${e}=${__PRIVATE_canonifyExpr(t)}`)).join(",")}`;
}
function __PRIVATE_canonifyPipeline(e) {
	return e.stages.map(((e) => __PRIVATE_canonifyStage(e))).join("|");
}
...
function __PRIVATE_canonifyQueryOrPipeline(e) {
	return __PRIVATE_isPipeline(e) ? __PRIVATE_canonifyPipeline(e) : function __PRIVATE_canonifyQuery(e) {
...
function evaluate(e, t, n) {
	...
	if (t instanceof Z) return function __PRIVATE_evaluateDatabase(e, t, n) {
...
function __PRIVATE_newPipelineComparator(e) {
	const t = function __PRIVATE_lastEffectiveSort(e) {
		for (let t = e.stages.length - 1; t >= 0; t--) {
			const n = e.stages[t];
			if (n instanceof L) return n.orderings;
		}
...
*/ var LocalDocumentsView = class {
	...
	*/ computeViews(e, t, n, r) {
		...
		return t.forEach(((e, t) => {
			const _ = n.get(t.key);
			r.has(t.key) && (void 0 === _ || _.mutation instanceof __PRIVATE_PatchMutation) ? i = i.insert(t.key, t) : void 0 !== _ ? (s.set(t.key, _.mutation.getFieldMask()), __PRIVATE_mutationApplyToLocalView(_.mutation, t, _.mutation.getFieldMask(), Timestamp.now())) : s.set(t.key, FieldMask.empty());
		})), this.recalculateAndSaveOverlays(e, i).next(((e) => (e.forEach(((e, t) => s.set(e, t))), t.forEach(((e, t) => _.set(e, new OverlayedDocument(t, s.get(e) ?? null)))), _)));
	}
	recalculateAndSaveOverlays(e, t) {
		...
		return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e, t).next(((e) => {
			for (const i of e) i.keys().forEach(((e) => {
				const s = t.get(e);
				if (null === s) return;
				let _ = n.get(e) || FieldMask.empty();
				_ = i.applyToLocalView(s, _), n.set(e, _);
				const o = (r.get(i.batchId) || __PRIVATE_documentKeySet()).add(e);
				r = r.insert(i.batchId, o);
			}));
		})).next((() => {
			const s = [], _ = r.getReverseIterator();
			for (; _.hasNext();) {
				const r = _.getNext(), o = r.key, a = r.value, u = __PRIVATE_newMutationMap();
				a.forEach(((e) => {
					if (!i.has(e)) {
	...
	*/ getNextDocuments(e, t, n, r) {
	...
	getDocumentsMatchingCollectionGroupQuery(e, t, n, r) {
		...
		let s = documentMap();
		return this.indexManager.getCollectionParents(e, i).next(((_) => PersistencePromise.forEach(_, ((_) => {
	...
	getDocumentsMatchingCollectionQuery(e, t, n, r) {
		let i;
		return this.documentOverlayCache.getOverlaysForCollection(e, t.path, n.largestBatchId).next(((s) => (i = s, this.remoteDocumentCache.getDocumentsMatchingQuery(e, t, n, i, r)))).next(((e) => this.retrieveMatchingLocalDocuments(i, e, ((e) => __PRIVATE_queryMatches(t, e)))));
	}
	getDocumentsMatchingPipeline(t, n, r, i) {
		if ("collection_group" === getPipelineSourceType(n)) {
			const e = getPipelineCollectionGroup(n);
			let s = documentMap();
			return this.indexManager.getCollectionParents(t, e).next(((_) => PersistencePromise.forEach(_, ((_) => {
				const o = function __PRIVATE_asCollectionPipelineAtPath(e, t) {
					const n = e.stages.map(((e) => e instanceof Y ? new X(t.canonicalString(), {}) : e));
					return new CorePipeline(e.serializer, n);
				}(n, _.child(e));
				return this.getDocumentsMatchingPipeline(t, o, r, i).next(((e) => {
					e.forEach(((e, t) => {
						s = s.insert(e, t);
					}));
				}));
		...
		{
			let s;
			return this.getOverlaysForPipeline(t, n, r.largestBatchId).next(((_) => {
				switch (s = _, getPipelineSourceType(n)) {
					case "collection": return this.remoteDocumentCache.getDocumentsMatchingQuery(t, n, r, s, i);
					case "documents":
						let _ = __PRIVATE_documentKeySet();
						for (const e of getPipelineDocuments(n)) _ = _.add(DocumentKey.fromPath(e));
						return this.remoteDocumentCache.getEntries(t, _);
					case "database": return this.remoteDocumentCache.getAllEntries(t);
					default: throw new e("invalid-argument", `Invalid pipeline source to execute offline: ${__PRIVATE_canonifyPipeline(n)}`);
				}
			})).next(((e) => this.retrieveMatchingLocalDocuments(s, e, ((e) => __PRIVATE_pipelineMatches(n, e)))));
		}
	}
	retrieveMatchingLocalDocuments(e, t, n) {
		e.forEach(((e, n) => {
			const r = n.getKey();
			null === t.get(r) && (t = t.insert(r, MutableDocument.newInvalidDocument(r)));
		}));
		let r = documentMap();
		return t.forEach(((t, i) => {
			const s = e.get(t);
			void 0 !== s && __PRIVATE_mutationApplyToLocalView(s.mutation, i, FieldMask.empty(), Timestamp.now()), n(i) && (r = r.insert(t, i));
		})), r;
	}
	getOverlaysForPipeline(t, n, r) {
		switch (getPipelineSourceType(n)) {
			case "collection": return this.documentOverlayCache.getOverlaysForCollection(t, ResourcePath.fromString(getPipelineCollection(n)), r);
			case "collection_group": throw new e("invalid-argument", `Unexpected collection group pipeline: ${__PRIVATE_canonifyPipeline(n)}`);
			case "documents": return this.documentOverlayCache.getOverlays(t, getPipelineDocuments(n).map(((e) => DocumentKey.fromPath(e))));
			case "database": return this.documentOverlayCache.getAllOverlays(t, r);
			default: throw new e("invalid-argument", `Failed to get overlays for pipeline: ${__PRIVATE_canonifyPipeline(n)}`);
		}
	}
};
/**
...
*/ var __PRIVATE_MemoryDocumentOverlayCache = class {
	...
	getOverlaysForCollection(e, t, n) {
		...
		for (; _.hasNext();) {
			const e = _.getNext().value, s = e.getKey();
...
var __PRIVATE_MemoryRemoteDocumentCacheImpl = class {
	...
	*/ removeEntry(e) {
	...
	getDocumentsMatchingQuery(e, t, n, r) {
		let i, s;
		__PRIVATE_isPipeline(t) ? (i = ResourcePath.fromString(getPipelineCollection(t)), s = (e) => __PRIVATE_pipelineMatches(t, e)) : (i = t.path, s = (e) => __PRIVATE_queryMatches(t, e));
		...
		for (; a.hasNext();) {
			const { key: e, value: { document: t } } = a.getNext();
			if (!i.isPrefixOf(e.path)) break;
			e.path.length > i.length + 1 || __PRIVATE_indexOffsetComparator(__PRIVATE_newIndexOffsetFromDocument(t), n) <= 0 || (r.has(t.key) || s(t)) && (_ = _.insert(t.key, t.mutableCopy()));
		}
		return PersistencePromise.resolve(_);
	}
...
function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
	...
	return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", ((e) => {
		const r = t.batch.keys(), i = n.ko.newChangeBuffer({ trackRemovals: true });
...
function __PRIVATE_localStoreGetNextMutationBatch(e, t) {
	const n = __PRIVATE_debugCast(e);
	return n.persistence.runTransaction("Get next mutation batch", "readonly", ((e) => (void 0 === t && (t = Ke), n.mutationQueue.getNextMutationBatchAfterBatchId(e, t))));
}
/**
...
async function __PRIVATE_fillWritePipeline(e) {
	...
	let r = t.sa.length > 0 ? t.sa[t.sa.length - 1].batchId : Ke;
...
*/ function __PRIVATE_canAddToWritePipeline(e) {
	return __PRIVATE_canUseNetwork(e) && e.sa.length < 10;
}
/**
...
function __PRIVATE_shouldStartWriteStream(e) {
	return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWriteStream(e).Jt() && e.sa.length > 0;
}
function __PRIVATE_startWriteStream(e) {
	__PRIVATE_ensureWriteStream(e).start();
}
async function __PRIVATE_onWriteStreamOpen(e) {
	__PRIVATE_ensureWriteStream(e).fn();
}
async function __PRIVATE_onWriteHandshakeComplete(e) {
	const t = __PRIVATE_ensureWriteStream(e);
	for (const n of e.sa) t.An(n.mutations);
}
async function __PRIVATE_onMutationResult(e, t, n) {
	const r = e.sa.shift(), i = MutationBatchResult.from(r, t, n);
	await __PRIVATE_executeWithRecovery(e, (() => e.remoteSyncer.applySuccessfulWrite(i))), await __PRIVATE_fillWritePipeline(e);
}
async function __PRIVATE_onWriteStreamClose(e, t) {
	t && __PRIVATE_ensureWriteStream(e).Rn && await async function __PRIVATE_handleWriteError(e, t) {
		if (function __PRIVATE_isPermanentWriteError(e) {
			return __PRIVATE_isPermanentError(e) && e !== ta.ABORTED;
		}(t.code)) {
			const n = e.sa.shift();
			__PRIVATE_ensureWriteStream(e).Xt(), await __PRIVATE_executeWithRecovery(e, (() => e.remoteSyncer.rejectFailedWrite(n.batchId, t))), await __PRIVATE_fillWritePipeline(e);
		}
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.Ra || (e.Ra = function __PRIVATE_newPersistentWriteStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		return r.pn(), new __PRIVATE_PersistentWriteStream(t, r.connection, r.authCredentials, r.appCheckCredentials, r.serializer, n);
	}(e.datastore, e.asyncQueue, {
		ct: () => Promise.resolve(),
		Et: __PRIVATE_onWriteStreamOpen.bind(null, e),
		Tt: __PRIVATE_onWriteStreamClose.bind(null, e),
		Vn: __PRIVATE_onWriteHandshakeComplete.bind(null, e),
		dn: __PRIVATE_onMutationResult.bind(null, e)
	}), e.Ea.push((async (t) => {
		t ? (e.Ra.Xt(), await __PRIVATE_fillWritePipeline(e)) : (await e.Ra.stop(), e.sa.length > 0 && (__PRIVATE_logDebug(hr, `Stopping write stream with ${e.sa.length} pending writes`), e.sa = []));
	}))), e.Ra;
}
/**
* @license
...
var DelayedOperation = class DelayedOperation {
	...
	*/ cancel(t) {
		null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new e(ta.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
	}
	handleDelayElapsed() {
...
*/ async function __PRIVATE_syncEngineWrite(e, t, n) {
	...
	try {
			...
			return n.persistence.runTransaction("Locally write mutations", "readwrite", ((e) => {
				...
				return n.ko.getEntries(e, i).next(((e) => {
					...
					for (const e of t) {
						...
						null != t && _.push(new __PRIVATE_PatchMutation(e.key, t, __PRIVATE_extractFieldMask(t.value.mapValue), Precondition.exists(!0)));
					}
		...
		r.sharedClientState.addPendingMutation(e.batchId), function __PRIVATE_addMutationCallback(e, t, n) {
			...
			r = r.insert(t, n), e.dc[e.currentUser.toKey()] = r;
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function __PRIVATE_processUserCallback(e, t, n) {
	const r = __PRIVATE_debugCast(e);
	let i = r.dc[r.currentUser.toKey()];
	if (i) {
		const e = i.get(t);
...
*/ var mr = class DocumentSnapshot {
	...
	*/ get ref() {
		return new aa(this._firestore, this._converter, this._key);
	}
	/**
	...
	*/
	get(e) {
		if (this._document) {
			const t = this._document.data.field(K("DocumentSnapshot.get", e));
			if (null !== t) return this._userDataWriter.convertValue(t);
		}
	}
};
var pr = class QueryDocumentSnapshot extends mr {
	/**
...
*/ var DocumentSnapshot = class DocumentSnapshot extends mr {
	...
	*/
	get(e, t = {}) {
		if (this._document) {
			const n = this._document.data.field(K("DocumentSnapshot.get", e));
	...
	*/ toJSON() {
		if (this.metadata.hasPendingWrites) throw new e(ta.FAILED_PRECONDITION, "DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
		const t = this._document, n = {};
		if (n.type = DocumentSnapshot._jsonSchemaVersion, n.bundle = "", n.bundleSource = "DocumentSnapshot", n.bundleName = this._key.toString(), !t || !t.isValidDocument() || !t.isFoundDocument()) return n;
		this._userDataWriter.convertObjectMap(t.data.value.mapValue.fields, "previous");
		return n.bundle = (this._firestore, this.ref.path, "NOT SUPPORTED"), n;
	}
};
/**
* A `QueryDocumentSnapshot` contains data read from a document in your
...
*/ var QuerySnapshot = class QuerySnapshot {
	...
	*/ docChanges(t = {}) {
		...
		if (n && this._snapshot.excludesMetadataChanges) throw new e(ta.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
		return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === n || (this._cachedChanges = function __PRIVATE_changesFromSnapshot(e, t) {
	...
	*/ toJSON() {
		if (this.metadata.hasPendingWrites) throw new e(ta.FAILED_PRECONDITION, "QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
		const t = {};
		...
		return this.docs.forEach(((e) => {
			null !== e._document && (n.push(e._document), r.push(this._userDataWriter.convertObjectMap(e._document.data.value.mapValue.fields, "previous")), i.push(e.ref.path));
...
* the document.
*/ function addDoc(e, t) {
	const n = ra(e.firestore, da), r = doc(e), s = __PRIVATE_applyFirestoreDataConverter(e.converter, t);
	return executeWrite(n, [__PRIVATE_parseSetData(la(e.firestore), "addDoc", r._key, s, null !== e.converter, {}).toMutation(r._key, Precondition.exists(false))]).then((() => r));
}
/**
* @license
* Copyright 2020 Google LLC
...
*/ function executeWrite(e, t) {
	return __PRIVATE_firestoreClientWrite(oa(e), t);
}
/**
* @license
* Copyright 2021 Google LLC
...
//#endregion
export { query as a, getFirestore as c, orderBy as i, serverTimestamp as l, deleteDoc as n, collection as o, getDocs as r, doc as s, addDoc as t };
