...
var getDefaultsFromEnvVariable = () => {
	...
	const defaultsJsonString = processModule.env.__FIREBASE_DEFAULTS__;
...
function isNode() {
	...
	try {
		return Object.prototype.toString.call(globalthis_default.process) === "[object process]";
	} catch (e) {
		return false;
	}
}
...
//#endregion
export { isMobileCordova as A, getModularInstance as C, isCloudflareWorker as D, isCloudWorkstation as E, querystringDecode as F, globalthis_default as I, isSafari as M, pingServer as N, isEmpty as O, querystring as P, getExperimentalSetting as S, isBrowserExtension as T, createSubscribe as _, getApp as a, getDefaultEmulatorHost as b, registerVersion as c, Component as d, Deferred as f, createMockUserToken as g, base64Decode as h, _registerComponent as i, isReactNative as j, isIE as k, LogLevel as l, FirebaseError as m, _getProvider as n, getApps as o, ErrorFactory as p, _isFirebaseServerApp as r, initializeApp as s, SDK_VERSION as t, Logger as u, deepEqual as v, getUA as w, getDefaultEmulatorHostnameAndPort as x, extractQuerystring as y };
